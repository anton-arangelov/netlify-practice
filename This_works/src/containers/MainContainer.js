...
const MainContainer = (props) => {
  ...
  const selectedEpisodeId = useSelector(
    (state) => state.episodes.selectedEpisodeId
  );
              ...
              <Fragment>
                ...
                {invalidUsername && (
                  <p className={classes.P}>
                    Username should include only alphabetic characters
                  </p>
                )}
              </Fragment>
            ) : (
              <Fragment>
                {stateEpisodes ? <AllEpisodes /> : <p>Loading...</p>}
              </Fragment>
            )}
          </Fragment>
        </Route>

        <Route path={`/${selectedEpisodeId}/origin/:charId`} exact>
          <Origin />
        </Route>
        <Route path={`/${selectedEpisodeId}/location/:charId`} exact>
          <Location />
        </Route>
