...
const Header = (props) => {
  ...
  const onLogoutHandler = () => {
    setDetailedSearchIsVisible(false);
    props.clicked();
  };
  ...
  return (
    <Fragment>
        ...
        {stateSigned && (
          <Fragment>
            ...
            {/* <div className={classes.DropDown}>
              <button onClick={onClickButtonHandler} onBlur={onBlurHandler}>
                {val}
              </button>
              {!showable && (
                <section className={classes.Options}>
                  <p style={{marginTop: '-0.01em'}}onClick={onClickHandler}>alive</p>
                  <p style={{marginTop: '-0.9em'}} onClick={onClickHandler}>dead</p>
                  <p style={{marginTop: '-0.9em', marginBottom: '0em'}} onClick={onClickHandler}>unknown</p>
                </section>
              )}
            </div> */}
            {/* --------------------------------------------- */}
      ...
      {detailedSearchIsVisible && stateSigned && (
